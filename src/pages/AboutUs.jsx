        ...
        <div className="flex flex-col md:flex-row my-5 gap-6 px-2 md:px-0">
          <div className="flex-1">
            <h1 className="font-medium text-3xl my-3 border-b-[3px] pb-2 border-black dark:border-white">
              Our Tech Titan Journey
            </h1>
            <p className="text-lg font-medium my-3">
              In 2020, Tech Titan embarked on a remarkable journey, driven by
              our unwavering passion for technology and innovation. We started
              as a small tech store with a big dream – to provide access to
              cutting-edge electronics and empower individuals and businesses
              with the latest tech solutions. Over the years, our commitment to
              excellence and dedication to customer satisfaction have propelled
              us from a humble beginning to becoming a renowned destination for
              tech enthusiasts. Today, as Tech Titan continues to evolve, our
              mission is clear: to redefine and elevate the tech experience for
            ...
            <p className="text-lg font-medium my-5">
              ...
              access cutting-edge technology while delivering the best in
