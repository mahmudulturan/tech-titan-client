    ...
    <div data-aos="fade-up">
      <div
        ...
        <div className="bg-white/60 dark:bg-gray-900/60">
          <div className="md:w-10/12 mx-auto min-h-[93vh] flex items-center justify-between">
            ...
            <div className="" style={{backgroundImage: 'url(https://i.ibb.co/c6gtjRs/magicpattern-blob-1697582987246.png)', backgroundSize: 'cover'}}>
              <img
                data-aos="zoom-out"
