...
const Navbar = () => {
  ...
  const navLinks = links.map((link, indx) => (
    <NavLink
      key={indx}
      to={link.path}
  ...
  return (
    <div data-aos="fade-down">
      ...
      <label className="swap swap-rotate md:hidden">
            ...
            <svg
              className="swap-off fill-current w-7 md:w-9 h-10"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24">
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[10] p-2 shadow bg-white dark:bg-gray-900 rounded-box w-52">
              {navLinks}
            </ul>
          </div>
          <img src={logo} className="w-5/6 md:w-3/12" alt="tech titan logo" />
          <div className="navbar-center mx-10 hidden lg:flex gap-6">
            {navLinks}
          </div>
        </div>
        <div className="navbar-end">
          {user ? (
            <div className="dropdown dropdown-end mx-1 md:mx-4">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 z-[10] p-2 shadow bg-white dark:bg-gray-900 rounded-box  min-w-max">
                <li>
                  {
                    user.displayName?
